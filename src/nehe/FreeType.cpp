...
void
font_data::init(const char* fname, unsigned int h) {
...
void
putchar(const font_data& ft_font, int ch) {
...
void
write_str(const font_data& ft_font, float h, const char* text) {
...
/// with freetype fonts.
void
print(const font_data& ft_font, float x, float y, const char* fmt, ...) {
